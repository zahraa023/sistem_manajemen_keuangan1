  ...
  <div class="container">
    ...
    <div class="right-side">
      <div class="login-box">
        ...
        <!-- Role Tabs -->
        <div class="role-tabs">
          <button class="role-tab active" onclick="switchTab('dasboard.admin', event)">ADMIN</button>
          <button class="role-tab" onclick="switchTab('dashben', event)">BENDAHARA</button>
        </div>
